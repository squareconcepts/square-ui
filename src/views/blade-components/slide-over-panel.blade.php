<div>
    @teleport('body')
        <div x-data="slideOverPanel('{{ $identifier }}')" x-on:toggle-{{$identifier}}.window="toggle" id="slideover-{{ $identifier }}-container" class="w-full h-full fixed inset-0 invisible z-[101]">
            ...
            >
                <div x-on:click="toggl" class="absolute cursor-pointer text-gray-600 top-0 w-8 h-8 flex items-center justify-center right-0 mt-5 mr-5 z-[101]]">

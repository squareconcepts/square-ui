...
<x-square-ui.session::base name="{{$name}}" :timeout-in-seconds="$timeoutInSeconds">
    <flux:callout icon="exclamation-circle" variant="warning" class="relative overflow-hidden">
        ...
        <div class="w-full absolute left-0 right-0 bottom-0 h-1 rounded">
            <div class="h-1 bg-amber-800  text-xl transition-all rounded" :style="{ width: progress + '%' }"></div>
        </div>
    </flux:callout>
